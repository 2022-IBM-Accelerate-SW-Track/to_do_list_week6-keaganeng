...
// ensures that the user has provided authentication
...
// creates new users and adds them to the store
...
// checks for signed cookies on requests that indicate that a user has already been authenticated
